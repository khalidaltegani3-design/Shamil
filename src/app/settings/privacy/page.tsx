...
const PrivacyOption = ({ icon: Icon, title, description, value }: { icon: React.ElementType, title: string, description: string, value: string }) => (
    ...
    <div className="flex flex-col h-full bg-background text-foreground">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-6">
        <Card className="p-2">
            ...
            <Separator />
            <PrivacyOption icon={EyeOff} title="Last seen & online" description="" value="Everyone" />
            <PrivacyOption icon={UserCheck} title="Profile photo" description="" value="Everyone" />
            <PrivacyOption icon={Clock} title="Status" description="" value="My contacts" />
        </Card>

         <Card className="p-2">
            <h3 className="font-semibold text-muted-foreground p-3">Manage who can contact you</h3>
            <Separator />
            <PrivacyOption icon={UserX} title="Blocked contacts" description="" value="3" />
        </Card>
      </div>
    </div>
  );
